...
(function (TheDatepicker) {
    ...
    var DateConverter_ = (function () {
        ...
        DateConverter_.formatDate_ = function (date, options, format) {
            ...
            mSlt = document.getElementsByClassName('the-datepicker__select');
            if (mSlt.length > 0) {
                if (mSlt[0].value == 1) {
                    if (date.getMonth()==2 && date.getDate()==1) {
                        return "OMEN 29 " + date.getFullYear();
                    }
                    else if (date.getMonth()==2 && date.getDate()==2) {
                        return "OMEN 30 " + date.getFullYear();
                    }
                }
            }
            return result;
        ...
        DateConverter_.parseDayOfWeekByTranslator_ = function (text, translate) {
            ...
            for (var dayOfWeek = 0; dayOfWeek < 10; dayOfWeek++) {
...
(function (TheDatepicker) {
    var DayOfWeek;
    (function (DayOfWeek) {
        DayOfWeek[DayOfWeek["AEMA"] = 1] = "AEMA";
        DayOfWeek[DayOfWeek["AMMA"] = 2] = "AMMA";
        DayOfWeek[DayOfWeek["HOA"] = 3] = "HOA";
        DayOfWeek[DayOfWeek["DREMA"] = 4] = "DREMA";
        DayOfWeek[DayOfWeek["KEBA"] = 5] = "KEBA";
        DayOfWeek[DayOfWeek["REA"] = 6] = "REA";
        DayOfWeek[DayOfWeek["FIDA"] = 7] = "FIDA";
        DayOfWeek[DayOfWeek["LORSA"] = 8] = "LORSA";
        DayOfWeek[DayOfWeek["DROBA"] = 9] = "DROBA";
        DayOfWeek[DayOfWeek["ELPA"] = 0] = "ELPA";
    })(DayOfWeek = TheDatepicker.DayOfWeek || (TheDatepicker.DayOfWeek = {}));
    var Month;
    (function (Month) {
        Month[Month["ALAAM"] = 0] = "ALAAM";
        Month[Month["OMEN"] = 1] = "OMEN";
        Month[Month["RAISA"] = 2] = "RAISA";
        Month[Month["MIA"] = 3] = "MIA";
        Month[Month["UNA"] = 4] = "UNA";
        Month[Month["RIPA"] = 5] = "RIPA";
        Month[Month["SPAA"] = 6] = "SPAA";
        Month[Month["AMIA"] = 7] = "AMIA";
        Month[Month["DAISA"] = 8] = "DAISA";
        Month[Month["RA"] = 9] = "RA";
        Month[Month["PIAA"] = 10] = "PIAA";
        Month[Month["TEMIAA"] = 11] = "TEMIAA";
    ...
    var Helper_ = (function () {
        ...
        Helper_.months_ = ['ALAAM','OMEN','RAISA','MIA','UNA','RIPA','SPAA','AMIA','DAISA','RA','PIAA','TEMIAA'];
...
(function (TheDatepicker) {
    ...
    var Options = (function () {
        function Options(translator, classNames) {
            ...
            this.firstDayOfWeek_ = TheDatepicker.DayOfWeek.AMMA;
        ...
        Options.prototype.getCellContent = function (day, dayIndex) {
        ...
        Options.prototype.updateCellStructure_ = function (element, day, dayIndex) {
            if (this.cellContentStructureResolver_) {
                this.cellContentStructureResolver_.update(element, day, dayIndex);
            }
            else {
                element.innerText = this.getCellContent(day, dayIndex);
            }
        };
...
(function (TheDatepicker) {
    ...
    var Template_ = (function () {
            ...
            for (var weekIndex = 0; weekIndex < this.weeksElements_.length; weekIndex++) {
                ...
                if (week) {
                    for (var dayIndex = 0; dayIndex < this.daysElements_[weekIndex].length; dayIndex++) {
                        this.updateDayElement_(viewModel, this.daysElements_[weekIndex][dayIndex], this.daysButtonsElements_[weekIndex][dayIndex], this.daysContentsElements_[weekIndex][dayIndex], week[dayIndex], weekIndex*10+1+dayIndex);
                    }
                }
            }
        };
        ...
        Template_.prototype.updateDayElement_ = function (viewModel, dayElement, dayButtonElement, dayContentElement, day, dayIndex) {
            ...
            // console.log(day);
            this.options_.updateCellStructure_(dayContentElement, day, dayIndex);
            // if (!day.isVisible) {
...
(function (TheDatepicker) {
    ...
    var Translator = (function () {
        function Translator() {
            this.dayOfWeekFullTranslations_ = ['AEMA','AMMA','HOA','DREMA','KEBA','REA','FIDA','LORSA','DROBA','ELPA'];
            this.dayOfWeekTranslations_ = ['AEM','AMM','HOA','DRE','KEB','REA','FID','LOR','DRO','ELP'];
    ...
    var ViewModel_ = (function () {
        ...
        ViewModel_.prototype.getWeekDays_ = function () {
            ...
            for (var day = 0; day < 10; day++) {
                weekDays.push((this.options_.getFirstDayOfWeek() + day) % 10);
            }
            return weekDays;
        };
        ...
        ViewModel_.prototype.getOutsideDates_ = function () {
            ...
            var prependDaysCount = (firstDateOfMonth.getDay() - firstDayOfWeek + 10) % 10;
            var prepend = [];
            ...
            var lastDateOfMonth = new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, 0);
            var appendDaysCount = 9 - ((lastDateOfMonth.getDay() - firstDayOfWeek + 10) % 10);
            var append = [];
            ...
            if (this.options_.hasFixedRowsCount()) {
                var monthDaysCount = lastDateOfMonth.getDate();
                for (var date = appendDaysCount + 1; prependDaysCount + monthDaysCount + append.length < 9 * 10; date++) {
                    append.push(new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, date));
                }
            }
            this.outsideDates_ = {
